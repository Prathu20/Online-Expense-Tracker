...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
	<div class="container-fluid">
		<a class="navbar-brand" href="#"><i
			class="fa-solid fa-money-check"></i> Expence Tracker</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty loginUser }">
					<li class="nav-item"><a
						class="nav-link active" href="index.jsp" tabindex="-1"><i
				...
				<c:if test="${not empty loginUser }">
					...
					<li class="nav-item"><a class="nav-link active"
						href="view_expense.jsp" tabindex="-1"><i
							class="fa-solid fa-list"></i> View Expence</a></li>
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${not empty loginUser }">
					...
					<li class="nav-item"><a class="nav-link active"
						href="../LogoutServlet" tabindex="-1"><i
