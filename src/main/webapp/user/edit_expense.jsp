<%@page import="com.demo.entity.Expense"%>
<%@page import="com.demo.db.HibernateUtil"%>
<%@page import="com.demo.dao.ExpenseDao"%>
...
<h3 class="text-center text-white">Track and make your records with expense tracker</h3>
